...
export function createInitialStudents(): Student[] {
  return [
    ...
    { id: "student-吉田しゅん", name: "吉田しゅん", grade: "中3" },
    ...
    { id: "student-松口聡真", name: "松口聡真", grade: "小6" },
    { id: "student-清水晋吾", name: "清水晋吾", grade: "小6" },
